...
def SAM(image_file_name, classified_file_name, library_file_name, scores_file_name=None, class_names=None,
    ...
    dataSet = parallel.ImageDataSet(length, N, indices, resampling_matrix, classified, scored) 
    model = parallel.ImageParallelModel()
